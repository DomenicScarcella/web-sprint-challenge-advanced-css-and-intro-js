...
// const changeName = function(array, index, key, string){
//   array[index][key] = string;
//   return array;
// }

// console.log(changeName(artists, 8, 'name', 'Vincent Van Gogh'));
...
function get20s(array){
  ...
  for(let i = 0; i < array.length; i++){
    if(array[i]['years'].includes('190')){
      get20sResults.push(array[i].name);
    } 
  }
  return get20sResults;
}
...
function addArtist(array){
    array.push({id: 20,
      ...
      bio: 'Add 1-2 sentences. This is a sentence.  This is also a sentence.'});
    return array;
  }
