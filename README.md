...
2. Talk about 3 different things you can do to ensure your website is accessible.
  ...
  * Use semantic tags/elements
  * Fill in page Titles with appropriate name of page
  * Give descriptions of images using alt="" in the img elements
...
4. What is the purpose of using functions in code?
  ...
  * Functions allow data to be accessed and processed in tasks.   Functions are how we use the data.
